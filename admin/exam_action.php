	...
	if($_POST["action"] == 'Add')
	{
		...
		else
		{
			$data = array(
				...
				':exam_result_date'			=>  $object->now,
				':exam_result_published'	=>  'No',	
				':exam_status'				=>	'Enable',
			...
			(class_id, exam_name, exam_result_date, exam_result_published, exam_status, exam_added_on) 
			VALUES (:class_id, :exam_name, :exam_result_date, :exam_result_published, :exam_status, :exam_added_on)
			";
