...
?>
	...
	<div class="card">
		<div class="card-header">
			<div class="row">
				...
				<div class="col col-sm-6 text-right">
					<a href="<?php echo $object->base_url; ?>" class="btn btn-warning">Back</a>
				</div>
			</div>
		</div>
		<div class="card-body">
			...
			if(isset($_POST["submit"]))
			{
				...
				if($object->row_count() > 0)
				{
					...
					foreach($result_data as $result)
					{
						...
						{
							echo '<h4 align="center">Your Result has put on hold contact Admin of Examination Section</h4>';
						}
					}
				}
				else
				{
					echo '<h4 align="center">Oops! No Result Found</h4>';
				}
			}
			else
			{
		...
		<div class="card-footer text-center">
			<p class="danger">Note: In case of any dispute in result please contact our support team on the given link below.</p>
			<a disabled>Sorry! this link is under maintenance, Support team will come back soon.</a>
		</div>
	</div>
	<br />
			<br />
